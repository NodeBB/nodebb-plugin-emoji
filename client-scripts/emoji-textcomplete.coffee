  ...
  exports.ready.then ->
    ...
    require ['composer', 'composer/controls'], (composer, controls) ->
      composer.addButton 'fa fa-smile-o', (area, sS, sE) ->
        ...
        dialogContent = $ '<p></p>'
        dialogContent.append '<h5>People</h5>'
        dialogContent.append getLink item for item in lists.people
        dialogContent.append '<hr /><h5>Nature</h5>'
        dialogContent.append getLink item for item in lists.nature
        dialogContent.append '<hr /><h5>Objects</h5>'
        dialogContent.append getLink item for item in lists.objects
        dialogContent.append '<hr /><h5>Places</h5>'
        dialogContent.append getLink item for item in lists.places
        dialogContent.append '<hr /><h5>Symbols</h5>'
        dialogContent.append getLink item for item in lists.symbols
