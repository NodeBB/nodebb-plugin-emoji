module.exports.composerHelp = (helpMessage, callback) ->
  ...
  helpMessage += """
    ...
    <p>
      ...
      Emoji begin and end with <code>:</code> like <code>:smile:</code>, <code>:wink:</code>, etc. For a full list see <a href="http://www.emoji-cheat-sheet.com">Emoji cheat sheet</a>.
    """
  if mappingEnabled
    helpMessage += """
      <br>
